...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseStatus', 'model/CollectionApiResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiResponseStatus'), require('./CollectionApiResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.AuthorizationApi) {
      root.AuthorizationApi = {};
    }
    root.AuthorizationApi.ApiResponse = factory(root.AuthorizationApi.ApiClient, root.AuthorizationApi.ApiResponseStatus, root.AuthorizationApi.CollectionApiResponse);
  }
}(this, function(ApiClient, ApiResponseStatus, CollectionApiResponse) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('errors')) {
        obj['errors'] = CollectionApiResponse.constructFromObject(data['errors']);
      }
  ...
  /**
   * @member {module:model/CollectionApiResponse} errors
   */
