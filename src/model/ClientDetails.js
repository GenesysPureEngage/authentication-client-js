...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CollectionGrantedAuthority'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CollectionGrantedAuthority'));
  } else {
    // Browser globals (root is window)
    if (!root.AuthorizationApi) {
      root.AuthorizationApi = {};
    }
    root.AuthorizationApi.ClientDetails = factory(root.AuthorizationApi.ApiClient, root.AuthorizationApi.CollectionGrantedAuthority);
  }
}(this, function(ApiClient, CollectionGrantedAuthority) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authorities')) {
        obj['authorities'] = CollectionGrantedAuthority.constructFromObject(data['authorities']);
      }
  ...
  /**
   * @member {module:model/CollectionGrantedAuthority} authorities
   */
