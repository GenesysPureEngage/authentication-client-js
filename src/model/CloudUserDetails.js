...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CollectionUserRole'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CollectionUserRole'));
  } else {
    // Browser globals (root is window)
    if (!root.AuthorizationApi) {
      root.AuthorizationApi = {};
    }
    root.AuthorizationApi.CloudUserDetails = factory(root.AuthorizationApi.ApiClient, root.AuthorizationApi.CollectionUserRole);
  }
}(this, function(ApiClient, CollectionUserRole) {
  'use strict';
   ...
   * @class
   * @param authorities {module:model/CollectionUserRole} Authorities assigned to user
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authorities')) {
        obj['authorities'] = CollectionUserRole.constructFromObject(data['authorities']);
      }
   ...
   * @member {module:model/CollectionUserRole} authorities
   */
