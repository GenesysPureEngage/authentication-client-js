...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AuthenticationApi.AuthenticationApi = factory(root.AuthenticationApi.ApiClient, root.AuthenticationApi.ApiResponse, root.AuthenticationApi.AuthSchemeLookupData, root.AuthenticationApi.ChangePasswordOperation, root.AuthenticationApi.CloudUserDetails, root.AuthenticationApi.DefaultOAuth2AccessToken, root.AuthenticationApi.ErrorResponse);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.convertTokenWithHttpInfo = function(authorization) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling convertToken");
      }
     ...
     */
    this.convertToken = function(authorization) {
      return this.convertTokenWithHttpInfo(authorization)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
