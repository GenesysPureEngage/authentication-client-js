...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseClientDetails', 'model/ClientDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BaseClientDetails'), require('../model/ClientDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.AuthorizationApi) {
      root.AuthorizationApi = {};
    }
    root.AuthorizationApi.ClientAPIApi = factory(root.AuthorizationApi.ApiClient, root.AuthorizationApi.BaseClientDetails, root.AuthorizationApi.ClientDetails);
  }
}(this, function(ApiClient, BaseClientDetails, ClientDetails) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.addClientWithHttpInfo = function(authorization, details) {
    ...
    this.addClient = function(authorization, details) {
      return this.addClientWithHttpInfo(authorization, details)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    this.getClientWithHttpInfo = function(authorization, id) {
      var postBody = null;
    ...
    this.getClient = function(authorization, id) {
      return this.getClientWithHttpInfo(authorization, id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    this.removeClientWithHttpInfo = function(authorization, id) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling removeClient");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object}
     */
    this.removeClient = function(authorization, id) {
      return this.removeClientWithHttpInfo(authorization, id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    this.updateClientWithHttpInfo = function(authorization, id, details) {
      var postBody = details;
    ...
    this.updateClient = function(authorization, id, details) {
      return this.updateClientWithHttpInfo(authorization, id, details)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
