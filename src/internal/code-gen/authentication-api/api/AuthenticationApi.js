...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRequestAuthSchemeLookupData', 'model/ApiRequestChangePasswordOperation', 'model/ApiResponse', 'model/CloudUserDetails', 'model/DefaultOAuth2AccessToken', 'model/ErrorResponse', 'model/OpenIdUserInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiRequestAuthSchemeLookupData'), require('../model/ApiRequestChangePasswordOperation'), require('../model/ApiResponse'), require('../model/CloudUserDetails'), require('../model/DefaultOAuth2AccessToken'), require('../model/ErrorResponse'), require('../model/OpenIdUserInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.AuthenticationApi) {
      root.AuthenticationApi = {};
    }
    root.AuthenticationApi.AuthenticationApi = factory(root.AuthenticationApi.ApiClient, root.AuthenticationApi.ApiRequestAuthSchemeLookupData, root.AuthenticationApi.ApiRequestChangePasswordOperation, root.AuthenticationApi.ApiResponse, root.AuthenticationApi.CloudUserDetails, root.AuthenticationApi.DefaultOAuth2AccessToken, root.AuthenticationApi.ErrorResponse, root.AuthenticationApi.OpenIdUserInfo);
  }
}(this, function(ApiClient, ApiRequestAuthSchemeLookupData, ApiRequestChangePasswordOperation, ApiResponse, CloudUserDetails, DefaultOAuth2AccessToken, ErrorResponse, OpenIdUserInfo) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.retrievePCTokenUsingPOSTWithHttpInfo = function() {
      var postBody = null;
     ...
     */
    this.retrievePCTokenUsingPOST = function() {
      return this.retrievePCTokenUsingPOSTWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/ApiRequestAuthSchemeLookupData} lookupData Data for scheme lookup.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponse} and HTTP response
     */
    this.tenantInfoWithHttpInfo = function(lookupData) {
      var postBody = lookupData;

      // verify the required parameter 'lookupData' is set
      if (lookupData === undefined || lookupData === null) {
        throw new Error("Missing the required parameter 'lookupData' when calling tenantInfo");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponse}
     */
    this.tenantInfo = function(lookupData) {
      return this.tenantInfoWithHttpInfo(lookupData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
