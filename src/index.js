...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/ApiResponseStatus', 'model/AuthSchemeLookupData', 'model/BaseClientDetails', 'model/ChangePasswordOperation', 'model/ClientDetails', 'model/CloudUserDetails', 'model/DefaultOAuth2AccessToken', 'model/ErrorResponse', 'model/GrantedAuthority', 'model/UserRole', 'api/AuthenticationApi', 'api/ClientAPIApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ApiResponse'), require('./model/ApiResponseStatus'), require('./model/AuthSchemeLookupData'), require('./model/BaseClientDetails'), require('./model/ChangePasswordOperation'), require('./model/ClientDetails'), require('./model/CloudUserDetails'), require('./model/DefaultOAuth2AccessToken'), require('./model/ErrorResponse'), require('./model/GrantedAuthority'), require('./model/UserRole'), require('./api/AuthenticationApi'), require('./api/ClientAPIApi'));
  }
}(function(ApiClient, ApiResponse, ApiResponseStatus, AuthSchemeLookupData, BaseClientDetails, ChangePasswordOperation, ClientDetails, CloudUserDetails, DefaultOAuth2AccessToken, ErrorResponse, GrantedAuthority, UserRole, AuthenticationApi, ClientAPIApi) {
  'use strict';
