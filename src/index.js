...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/AuthSchemeLookupData', 'model/ChangePasswordOperation', 'model/CloudUserDetails', 'model/DefaultOAuth2AccessToken', 'model/ErrorResponse', 'model/JwtConvertResult', 'model/ResponseStatus', 'model/UserRole', 'api/AuthenticationApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ApiResponse'), require('./model/AuthSchemeLookupData'), require('./model/ChangePasswordOperation'), require('./model/CloudUserDetails'), require('./model/DefaultOAuth2AccessToken'), require('./model/ErrorResponse'), require('./model/JwtConvertResult'), require('./model/ResponseStatus'), require('./model/UserRole'), require('./api/AuthenticationApi'));
  }
}(function(ApiClient, ApiResponse, AuthSchemeLookupData, ChangePasswordOperation, CloudUserDetails, DefaultOAuth2AccessToken, ErrorResponse, JwtConvertResult, ResponseStatus, UserRole, AuthenticationApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The JwtConvertResult model constructor.
     * @property {module:model/JwtConvertResult}
     */
    JwtConvertResult: JwtConvertResult,
    /**
